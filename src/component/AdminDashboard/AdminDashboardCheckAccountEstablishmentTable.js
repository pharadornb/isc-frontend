...
function AdminDashboardCheckAccountEstablishmentTable() {
    ...
    const originalRows1 = [
      ...
      { registration_number: "219534875447", establishment_name: "บริษัท ACC กัดจำ", status: "ไม่ผ่าน", address: "267/17, ไพรบึง, ศรีสะเกษ", account_opening_date: "03/03/12 22:43", manage_account: "รายละเอียด" },
      { registration_number: "219534875447", establishment_name: "บริษัท OPQ กัดจำ", status: "ผ่าน", address: "267/17, ไพรบึง, ศรีสะเกษ", account_opening_date: "03/03/12 22:43", manage_account: "รายละเอียด" },
    ];
    ...
    const requestSearch = (searchedVal) => {
        /* Search Table 1 */
            const filteredRows = originalRows1.filter((row) => {
                return row.establishment_name.toLowerCase().includes(searchedVal.toLowerCase());
              });
           ...
           <div class="row tb">
            ...
            <div class="row tb">
                    <table className={classes.table} aria-label="simple table">
                        <tr>
                            <th align="center"><label><b>เลขจดทะเบียน</b></label></th>
                            <th align="center"><label><b>สถานะ</b></label></th>
                            <th align="center"><label><b>ชื่อสถานประกอบการ</b></label></th>
                            <th align="center"><label><b>ที่อยู่</b></label></th>
                            <th align="center"><label><b>วันที่เปิดบัญชี</b></label></th>
                            <th align="center"><label><b>จัดการบัญชี</b></label></th>
                        </tr>
                        {rows1.map((row) => (
                            <tr key={row.establishment_name}>
