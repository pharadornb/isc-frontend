            ...
            {!userEmail && (
                <div className="bg-resume">
                    ...
                    <div className="div-1">
                        ...
                        <a
                            href="https://itsc-project.web.app/check_resume"
                            className="w lin"
                        >
                            https://itsc-project.web.app/check_resume (For company!)
                        </a>
                    </div>
                    <div className="goo"/>
                    <div className="container">
                        <div className="row div-2">
                            <div className="col-md-12 col-lg-5 div2-1">
                                {/* box left */}
                                ...
                                <div className="container">
                                    ...
                                    <div className="row div22-2 la">
                                        ...
                                        <div className="col-11 w">
                                            ...
                                            <label>
                                                จังหวัด {dataNUser.us_com_province}&nbsp;&nbsp;
                                            </label>
                                            <label>
                                                รหัสไปรษณีย์ {dataNUser.us_com_postcode}&nbsp;
                                            </label>
                                        </div>
                                    </div>
                                    <div className="row div22-2 la">
                                        ...
                                        <div className="row">
                                            ...
                                            >
                                                ...
                                                <label className="w ml">
                                                    {dataNUser.us_com_facebook}
                                                </label>
                                            </a>
                                            {/* youtube */}
                                            <a
                            ...
                            <div className="col-md-12 col-lg-6 div2-2">
                                ...
                                <div className="row ">
                                    {skilltypes.map((row1) => (
                                        <div key={row1.skill_type_id} className="col-12">
                                            <br/>
                                            <label className="b txttitle">
                                                {row1.skill_type_name}
                                            </label>
                                            <br/>
                                            <br/>
